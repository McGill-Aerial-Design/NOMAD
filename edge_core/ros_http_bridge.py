...
class ROSHTTPBridge(Node):
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "mag_heading_rad": round(self._mag_heading, 4) if self._mag_recv_count > 0 else None,
            "mag_heading_deg": round(self._mag_heading * 180.0 / 3.14159, 1) if self._mag_recv_count > 0 else None,
            "mag_last_ts": round(self._last_mag_ts, 2) if self._mag_recv_count > 0 else None,
