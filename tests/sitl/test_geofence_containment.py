...
"""Pytest wrapper for the SITL geofence containment scenario.

Skipped by default: it requires a live ArduPilot SITL reachable on two MAVLink
endpoints (operator + service), provided via ``NOMAD_SITL_OPERATOR`` and
...
from geofence_containment import run_scenario  # noqa: E402
