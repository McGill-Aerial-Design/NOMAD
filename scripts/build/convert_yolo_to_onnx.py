...
def main():
    parser = argparse.ArgumentParser(description="Convert YOLO .pt model to ONNX for ZED SDK custom object detection.")
    parser.add_argument(
        "--input",
        "-i",
        type=str,
    ...
    if output_path.exists():
        ...
        print(f"     scp {output_path} <jetson-user>@<jetson-ip>:~/NOMAD/config/models/best.onnx")
