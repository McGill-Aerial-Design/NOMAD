...
class OdomTap(Node):
    def __init__(self, topic: str):
        ...
        self.latest: OdomSample | None = None
...
def main() -> int:
    ...
    ap.add_argument("--api", default=os.environ.get("NOMAD_API_URL", "http://localhost:8000"))
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    if isinstance(data, dict) and "roll" in data and "pitch" in data and "yaw" in data:
                        ...
                        od_roll_ned, od_pitch_ned, od_yaw_ned = ros_odom_to_ned_deg(od.roll, od.pitch, od.yaw)
